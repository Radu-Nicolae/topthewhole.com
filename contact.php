  ...
  <!-- header-end -->
    ...
    <div class="bradcam_area bradcam_bg_1">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center"> <br>
                        <h3 style="text-transform: none;">Contactează-ne!</h3>
                    </div>
                </div>
            </div>
        </div>
  ...
  <section class="contact-section section_padding">
    <div class="container">
      <div class="d-none d-sm-block mb-5 pb-4">
        ...
        <script>
          function initMap() {
            var uluru = {lat: 44.4410485, lng: 26.0911533};
            var grayStyles = [
              {
                featureType: "all",
                stylers: [
            ...
            var map = new google.maps.Map(document.getElementById('map'), {
              center: {lat: 44.4410485, lng: 26.0911533},
              zoom: 18,
              styles: grayStyles,
              scrollwheel:  false
            });
        ...
        <div class="col-lg-4" style="margin-left:auto; margin-right:28%;">
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-home"></i></span>
            <div class="media-body" >
              <h3>București, Romania</h3>
              <p>Strada General H. M. Berthelot 23, 010168</p>
            </div>
          </div>
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3> 021 312 9294</h3>
              <p>Luni - Vineri: 7:30 - 13:30</p>
            </div>
          </div>
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-email"></i></span>
            <div class="media-body">
              <h3>contact@revista-cava.ro</h3>
              <p>Răspundem în cel mai scurt timp posibil</p>
            </div>
          </div>
        </div>
      </div>
